...
- scipy
   Virtanen, P., Gommers, R., Oliphant, T. E., Haberland, M., Reddy, T., Cournapeau, D., … & Van Mulbregt, P. (2020). SciPy 1.0: fundamental algorithms for scientific computing in Python. Nat Methods 17, 261–272. `https://doi.org/10.1038/s41592-019-0686-2 <https://doi.org/10.1038/s41592-019-0686-2>`_
- nibabel
   Matthew Brett (MB), Chris Markiewicz (CM), Michael Hanke (MH), Marc-Alexandre Côté (MC), Ben Cipollini (BC), Paul McCarthy (PM), Chris Cheng (CC), Yaroslav Halchenko (YOH), Satra Ghosh (SG), Eric Larson (EL), Demian Wassermann, Stephan Gerhard and Ross Markello (RM). (2020). NiBabel 3.1.1. Jun 30. `https://nipy.org/nibabel/ <https://nipy.org/nibabel/>`_
- torch
...
- **nstitute for Information and Communications Technology Planning and Evaluation (IITP) funded by the Korea Government (MSIT)**
